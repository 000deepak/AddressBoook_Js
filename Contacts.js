...
function addContact(contact) {
  ...
  let num = "0";
  addressBook.filter((contact1) =>
    name != contact1.firstName + " " + contact1.lastName ? num++ : num
  );
...
function findContact(firstName, lastName) {
  let foundContact = addressBook.find(
...
findContact("Robert","Brown")
updateDetails("Robert", "ZIP", "41456")
deleteContact( "Robert","Brown")
